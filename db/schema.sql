-- Esquema del curso remedial de matemáticas (Netlify DB / Neon Postgres)
...
-- Primer nodo de Álgebra, marcado como puente (requiere Aritmética completa)
...
-- Nodo puente: Jerarquía de operaciones requiere haber completado Aritmética
